...
export function useGameBoard() {
    ...
    const gameState = ref<GameData | null>(null);
    ...
    socket.on(GameEvents.GameStart, (data: GameData) => (gameState.value = data));
    socket.on(GameEvents.UpdateGameState, (data: GameData) => (gameState.value = data));
